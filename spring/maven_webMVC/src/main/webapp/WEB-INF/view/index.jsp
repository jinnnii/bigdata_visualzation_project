...
<div class="container text-center mt-5">
	<div class="row">
		<div class="col-lg-4">
			<img src="resources/images/kirby1.jpg" width="140" height="140"
		...
		<!-- /.col-lg-4 -->
		<div class="col-lg-4">
			<img src="resources/images/kirby2.jpg" width="140" height="140"
				class="rounded-circle">
			<h2>Heading</h2>
		...
		<!-- /.col-lg-4 -->
		<div class="col-lg-4">
			<img src="resources/images/kirby3.jpg" width="140" height="140"
				class="rounded-circle">
			<h2>Heading</h2>
