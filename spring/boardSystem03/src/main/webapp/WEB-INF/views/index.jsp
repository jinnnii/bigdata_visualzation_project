...
<div class="container">
	<!-- Carousel -->
	<div id="carouselExampleControls" class="carousel slide container mt-4"
		data-ride="carousel">
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img src="resources/images/image1.jpg" width="400" height="500"
					class="d-block w-100">
			</div>
			<div class="carousel-item">
				<img src="resources/images/image2.jpg" width="400" height="500"
					class="d-block w-100">
			</div>
			<div class="carousel-item">
				<img src="resources/images/image3.jpg" width="400" height="500"
					class="d-block w-100">
			</div>
			<div class="carousel-item">
				<img src="resources/images/image4.jpg" width="400" height="500"
					class="d-block w-100">
			</div>
		</div>
	...
	<div class="container text-center mt-5">
		<div class="row">
			<div class="col-lg-4">
				<img src="resources/images/image1.jpg" width="140" height="140"
			...
			<!-- /.col-lg-4 -->
			<div class="col-lg-4">
				<img src="resources/images/image2.jpg" width="140" height="140"
					class="rounded-circle">
				<h2>Heading</h2>
			...
			<!-- /.col-lg-4 -->
			<div class="col-lg-4">
				<img src="resources/images/image3.jpg" width="140" height="140"
					class="rounded-circle">
				<h2>Heading</h2>
