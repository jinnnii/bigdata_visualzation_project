	...
	<div id="carouselExampleControls" class="carousel slide container mt-4"
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img src="images/image1.jpg" width="400" height="500"
					class="d-block w-100">
			</div>
			<div class="carousel-item">
				<img src="images/image2.jpg" width="400" height="500"
					class="d-block w-100">
			</div>
			<div class="carousel-item">
				<img src="images/image3.jpg" width="400" height="500"
					class="d-block w-100">
			</div>
			<div class="carousel-item">
				<img src="images/image4.jpg" width="400" height="500"
					class="d-block w-100">
			</div>
		</div>
